...
public class ScheduleDetailPanel extends JPanel {
	...
	public ScheduleDetailPanel(ScheduleData scheduleData, JFrame thisFrame, JFrame mainFrame) {
		...
		SimpleDateFormat startFormat = new SimpleDateFormat("YY-MM-dd  HH:mm");
		SimpleDateFormat endFormat = new SimpleDateFormat("YY-MM-dd  HH:mm");
		...
		startDateLabel = new Label(startFormat.format(scheduleData.getStartDate().getTime()));
		endDateLabel = new Label(endFormat.format(scheduleData.getEndDate().getTime()));
